 ...
 */
class Magazento_CoreExport_Block_System_Convert_Gui_Edit extends Mage_Adminhtml_Block_Widget_Form_Container //Mage_Adminhtml_Block_System_Convert_Gui_Edit//
{
    public function __construct()
    {
        Mage::helper('coreexport')->log('Magazento_CoreExport_Block_System_Convert_Gui_Edit');

        $this->_objectId = 'id';
        $this->_controller = 'system_convert_gui'; //to think
        $this->_blockGroup = 'coreexport';
