 ...
 */
class Magazento_CoreExport_Block_System_Convert_Gui_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs //Mage_Adminhtml_Block_System_Convert_Gui_Edit_Tabs//Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        ...
        $wizardBlock = $this->getLayout()->createBlock('coreexport/system_convert_gui_edit_tab_wizard');
